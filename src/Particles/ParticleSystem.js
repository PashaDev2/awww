...
import { curlNoise4d } from "../TLS/curlNoise4d.js";
...
export class ParticleSystem {
    ...
    initialize() {
        ...
        const particlesInit = Fn(() => {
            ...
            life.assign(instanceIndex._cacheKey);
        });
        ...
        const particlesUpdate = Fn(() => {
            ...
            const turbulenceInput = position
                .mul(this.uniforms.turbulencePositionFrequeny)
                .add(12.34);
            const turbulence = curlNoise4d(
                vec4(turbulenceInput, time.mul(this.uniforms.turbulenceTimeFrequeny))
        ...
        this.material.positionNode = Fn(() => {
            ...
            sparkling.assign(
                If(
                    sparklingLife
                        .lessThan(sparklingTime)
                        .and(
                            sparklingLife.greaterThan(
                                sparklingTime.sub(
                                    this.uniforms.sparklingDuration.mul(
                                        this.uniforms.sparklingFrequency
                                    )
                                )
                            )
                        ),
        ...
        this.material.colorNode = Fn(() => {
            ...
            const alphaSolid = step(this.uniforms.solidRatio.div(2), distanceToCenter)
                .oneMinus()
